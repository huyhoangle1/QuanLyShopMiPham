...
class Dangnhap extends CI_Controller {
    ...
    public function dangnhap(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->data['title']='Miuxinh - Đăng nhập tài khoản';
            $this->data['view']='dangnhap';
            $this->load->view('frontend/layout',$this->data);
        }     
    }
    ...
    public function dangxuat(){
        $array_items = array( 'email','fullname', 'id','sessionKhachHang','sessionKhachHang_name','coupon_price','id_coupon_price', 'Cart');
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'sale.miuxinh.shop.2022@gmail.com';
            ...
            $this->email->from('sale.miuxinh.shop.2022@gmail.com', 'Miuxinh Shop');
            $this->email->to($email);
            $this->email->subject('Hệ thống MiuxinhShop - Quà thành viên mới');
            $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng Miuxinh, Cửa hàng tặng bạn 1 mã giảm giá giảm 100.000 đ : '.$tempcoupon.' , Mã này có giá trị tới ngày '.$tempdatelimit.'
        ...
        $this->data['title']='Miuxinh - Đăng ký tài khoản';   
    ...
    public function forget_password(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->email->subject('Hệ thống Miuxinh - Lấy lại mật khẩu');
        ...
        $this->data['title']='Miuxinh - Quên mật khẩu';   
    ...
    public function reset_password_new($id){
        ...
        if($this->form_validation->run() ==TRUE){ 
           ...
           if($this->Mcustomer->customer_check_id_email($id, $email)!=FALSE){
            ...
            $this->data['title']='Miuxinh - Cập nhật mật khẩu mới';
