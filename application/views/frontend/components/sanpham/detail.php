		...
		<div class="products-wrap">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="product-status">
								...
								<p style=" float: left;margin-right: 10px;">Đã bán: <?php  echo $row['number_buy']; ?></p>
			...
			<script>
				...
				function onAddCart(id){
					var strurl="<?php echo base_url();?>"+`/gio-hang/them-san-pham/${id}`;
					jQuery.ajax({
						url: strurl,
						type: 'GET',
						dataType: 'HTML',
						...
						success: function(data) {
							if(!data?.success) {
								...
								alert('Loi, Thêm sản phẩm vào giỏ hàng!');
							}
