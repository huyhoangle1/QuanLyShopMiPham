    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;" src="public/images/banner.jpg">
             <img style="width: 100%; height: 160px;" src="public/images/banner2.jpg">
         </div>
         <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 slider-main pull-left" style= "height: 100%;">
            <?php 
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue">Tin tức làm đẹp</h2>
            </div>
        </div>
