										...
										<tbody>
											<?php foreach ($list as $row):?>
												<tr>
													...
													<td class="text-center"> <?php echo $row['number_buy']  ?></td>
													<td class="text-center"> <?php if(($row['number'] - $row['number_buy'])>=0) echo $row['number'] - $row['number_buy'] 
																					?></td>
													<?php 
													...
													<td class="text-center">
														<a href="<?php echo base_url() ?>admin/product/status/<?php echo $row['id'] ?>">
															<?php if($row['status']==1&& ($row['number'] - $row['number_buy'])>0):?>
