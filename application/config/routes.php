...
// AJAX
$route['gio-hang/them-san-pham/(:num)'] = 'cartcontroller/addProduct/$1';
$route['gio-hang/cap-nhat-san-pham/(:num)/(:num)'] = 'cartcontroller/updateProduct/$1/$2';
$route['gio-hang/cap-nhat-san-pham-header'] = 'cartcontroller/updateProductHeader';
$route['gio-hang/xoa-san-pham/(:num)'] = 'cartcontroller/deleteProduct/$1';
